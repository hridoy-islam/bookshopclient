                    ...
                    {data.map(book =>
                        <tr>
                            <td class="whitespace-nowrap px-4 py-2 font-medium text-gray-900">
                                <img src={book.photo} alt="" className='w-12 h-12' />
                            </td>
                            ...
                            <td class="whitespace-nowrap px-4 py-2 text-gray-700">{book.publisher.name}</td>
                            <td class="whitespace-nowrap px-4 py-2 text-gray-700">{book.stock}</td>
                            <td class="whitespace-nowrap px-4 py-2 text-gray-700">{book.price}</td>
                            <td class="whitespace-nowrap px-4 py-2">
                                <div class="inline-flex rounded-lg border border-gray-100 bg-gray-100 p-1">
                                    <Link to={`/dashboard/books/edit/${book._id}`} class="inline-flex items-center gap-2 rounded-md px-4 py-2 text-sm text-gray-500 hover:text-gray-700 focus:relative"
                                    >
                                        <svg
